...
class Line(object):
    ...
    def clone(self):
        ...
        line_clone = Line(start, end)
        self.count_clones = self.count_clones + 1
        return line_clone
    ...
    def slope(self):
        ...
        dif_y = self.end.y - self.start.y
        dif_x = self.end.x - self.start.x
        if dif_x == 0:
            return math.inf
        else:
            return dif_y / dif_x
...
########################################################################
# The TEST functions for selfthe  Line  class begin here.
#
